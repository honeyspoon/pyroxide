...
test:
	...
	@for ex in 01_hello 02_structs 03_tensors 04_simd 05_dtype_generic 06_comptime 07_embeddings 08_abi_edge_cases 09_image_blur 10_tokenizer 11_neural_layer 12_accumulator; do \
		echo ""; \
		echo "===== $$ex ====="; \
